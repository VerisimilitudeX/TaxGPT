...
public class TaxGPT {
    ...
    public static String askGPT(String prompt) {
        ...
        String AUTHORIZATION_HEADER = "Bearer sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
        try {
    ...
    private static void summarizeUserInformation(String input) {
        ...
        for (String pair : pairs) {
            ...
            if (keyValue.length == 2) {
                ...
                userInformation.put("TaxGPT - I wasn't sure how to classify this, when outputting , fix it please",
                        pair);
            }
        }
    }
